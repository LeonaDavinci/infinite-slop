...
export default function LivePlayer() {
  ...
  return (
    <div className="relative aspect-video w-full overflow-hidden rounded-3xl bg-black shadow-2xl shadow-[#C5156B]/10">
      {overlay ? (
        <button
          type="button"
          onClick={() => setOverlay(false)}
          className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-black/60 text-white transition hover:bg-black/50"
