...
const faqs = [
  {
    ...
    answer:
      "Infinite Slop is a never-ending, interactive AI-generated live stream. Viewers type messages in chat, and Infiniteslop AI turns each message into the next generated video clip. The AI tries to connect the new clip to what came before, creating a loose but continuous storyline.",
  },
  {
        ...
        <section className="relative overflow-hidden px-4 py-24 sm:px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-7xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-zinc-600">
              Infinite Slop is a never-ending, interactive AI-generated live
              stream. Type in chat and Infiniteslop AI generates the next scene
              for you, stitched into the story. Watch Infiniteslop AI live, free,
              24/7.
            </p>
          ...
          <div className="mx-auto max-w-5xl overflow-hidden rounded-[2rem] bg-gradient-to-br from-[#8E2DE2]/10 to-[#C5156B]/10 p-1">
            <div className="rounded-[1.9rem] bg-white/90 px-8 py-16 text-center backdrop-blur-xl sm:px-16">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-lg text-zinc-600">
                The Infiniteslop AI live page mirrors the original broadcast.
                Unmute, open chat, and watch Infiniteslop AI generate video in
                real time — a 24/7 AI broadcast anyone can join for free. Read the
                announcement on{" "}
                <a
                  href={site.originPost}
                  target="_blank"
        ...
        <section className="px-4 py-24 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-6xl">
            <div className="mb-12 text-center">
              ...
              <p className="mt-4 text-lg text-zinc-600">
                Real screenshots from the Infiniteslop AI live stream — fresh
                hot moments generated by chat.
              </p>
            </div>
            <div className="grid gap-6 sm:grid-cols-2">
              ...
              >
                ...
                <img
                  src="/infiniteslop-live-stream.jpg"
                  alt="infiniteslop live stream"
                  className="aspect-video w-full object-cover transition group-hover:scale-[1.02]"
                />
                <div className="p-4">
                  <p className="font-medium text-zinc-900">infiniteslop live stream</p>
                  <p className="text-sm text-zinc-500">
                    Click to watch the 24/7 AI broadcast.
                  </p>
                </div>
              </a>
              <a
              ...
              >
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src="/infiniteslop-stream-live.jpg"
                  alt="infiniteslop stream live"
                  className="aspect-video w-full object-cover transition group-hover:scale-[1.02]"
                />
                <div className="p-4">
                  <p className="font-medium text-zinc-900">infiniteslop stream live</p>
                  <p className="text-sm text-zinc-500">
                    Fresh AI-generated scenes every minute.
                  </p>
                </div>
              </a>
            </div>
